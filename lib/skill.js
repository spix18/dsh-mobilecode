...
- Typing: ASCII goes through `input text` directly. Non-ASCII (Chinese, emoji) needs the ADBKeyboard IME — `device_input` uses it automatically when installed, and refuses with the install hint otherwise (github.com/senzhk/ADBKeyBoard); do not retry a refused non-ASCII type.
